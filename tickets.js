...
import { showToast, parseSheetDate, renderEmptyState, formatDateForSheet, calculateAgentCut, makeClickable, formatDateToDMMMY } from './utils.js';
...
export function displayTickets(tickets, page = 1) {
    ...
    paginated.forEach((ticket) => {
        ...
        // MODIFIED: Use dynamic import to break the circular dependency
